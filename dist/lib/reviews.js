...
var debug = (0, _debug["default"])('google-play-scraper:reviews');
function reviews(opts) {
  return new Promise(function (resolve, reject) {
    validate(opts);
    var fullOptions = Object.assign({
      sort: _constants.constants.sort.NEWEST,
      lang: 'en',
      country: 'us',
      num: 150,
      paginate: false,
...
function validate(opts) {
  ...
  if (opts.sort && !R.includes(opts.sort, R.values(_constants.constants.sort))) {
...
function getBodyForRequests(_ref2) {
  ...
  var formBody = _defineProperty(_defineProperty({}, REQUEST_TYPE.initial, "f.req=%5B%5B%5B%22UsvDTd%22%2C%22%5Bnull%2Cnull%2C%5B2%2C".concat(sort, "%2C%5B").concat(numberOfReviewsPerRequest, "%2Cnull%2Cnull%5D%2Cnull%2C%5B%5D%5D%2C%5B%5C%22").concat(appId, "%5C%22%2C7%5D%5D%22%2Cnull%2C%22generic%22%5D%5D%5D")), REQUEST_TYPE.paginated, "f.req=%5B%5B%5B%22UsvDTd%22%2C%22%5Bnull%2Cnull%2C%5B2%2C".concat(sort, "%2C%5B").concat(numberOfReviewsPerRequest, "%2Cnull%2C%5C%22").concat(withToken, "%5C%22%5D%2Cnull%2C%5B%5D%5D%2C%5B%5C%22").concat(appId, "%5C%22%2C7%5D%5D%22%2Cnull%2C%22generic%22%5D%5D%5D"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          parsedHtml = R.is(String, html) ? _scriptData["default"].parse(html) : html;
        ...
        case 5:
          ...
          reviewsAccumulator = [].concat(_toConsumableArray(savedReviews), _toConsumableArray(reviews));
...
function makeReviewsRequest(opts, savedReviews, nextToken) {
  ...
  var url = "".concat(_constants.BASE_URL, "/_/PlayStoreUi/data/batchexecute?rpcids=qnKhOb&f.sid=-697906427155521722&bl=boq_playuiserver_20190903.08_p0&hl=").concat(lang, "&gl=").concat(country, "&authuser&soc-app=121&soc-platform=1&soc-device=1&_reqid=1065213");
  ...
  return (0, _request["default"])(reviewRequestOptions, throttle).then(function (html) {
  ...
  var MAPPINGS = {
    ...
    url: {
      ...
      fun: function fun(reviewId) {
        return "".concat(_constants.BASE_URL, "/store/apps/details?id=").concat(appId, "&reviewId=").concat(reviewId);
      }
    },
    title: {
      path: [0],
    ...
    criterias: {
      path: [12, 0],
      fun: function fun() {
        var criterias = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
...
function generateDate(dateArray) {
  ...
  var millisecondsTotal = "".concat(dateArray[0]).concat(millisecondsLastDigits.substring(0, 3));
